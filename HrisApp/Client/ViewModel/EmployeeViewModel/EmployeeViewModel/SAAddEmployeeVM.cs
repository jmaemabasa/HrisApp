...
{
    public class SAAddEmployeeVM : BaseViewModel
    {
#nullable disable
        ...
        public SAAddEmployeeVM(NavigationManager navigationManager, GlobalConfigService globalConfigService)
        {
        ...
        public async Task<string> CreateEmployee()
        {
            ...
            else
            {
                try
                {
                    ...
                    _navigationManager.NavigateTo("saemployee");
