...
global using HrisApp.Client.Pages.Dialog.MasterData.UOM;
...
global using HrisApp.Shared.Models.Assets.Licenses;
...
global using HrisApp.Client.Services.Assets.AssetVehicleService;
global using HrisApp.Client.Services.Assets.Remarks.MainRemarksService;
global using HrisApp.Client.Services.Assets.Remarks.AccRemarksService;
global using HrisApp.Client.Services.Assets.Remarks.VhcRemarksService;
global using HrisApp.Client.Services.Assets.AssVehicleImageSvc;
global using HrisApp.Shared.Models.Assets.Consumables;
global using HrisApp.Client.Services.Assets.Consumables.ConsumablesService;
global using HrisApp.Client.Services.MasterData.UOMService;
global using HrisApp.Client.Services.Assets.Consumables.ConsumableImgService;
global using HrisApp.Client.Services.Assets.Remarks.ConsumeRemarksService;
global using HrisApp.Client.Services.Assets.Consumables.ConsTransactionService;
global using HrisApp.Client.Services.MasterData.VendorService;
global using HrisApp.Client.Services.Assets.Licenses.AssLicenseService;
global using HrisApp.Client.Services.Assets.Remarks.LicenseRemarksService;
...
builder.Services.AddScoped<IAssetVehicleService, AssetVehicleService>();
builder.Services.AddScoped<IMainRemarksService, MainRemarksService>();
builder.Services.AddScoped<IAccRemarksService, AccRemarksService>();
builder.Services.AddScoped<IVhcRemarksService, VhcRemarksService>();
builder.Services.AddScoped<IAssVehicleImageSvc, AssVehicleImageSvc>();
builder.Services.AddScoped<IConsumablesService, ConsumablesService>();
builder.Services.AddScoped<IConsumableImgService, ConsumableImgService>();
builder.Services.AddScoped<IConsumeRemarksService, ConsumeRemarksService>();
builder.Services.AddScoped<IConsTransactionService, ConsTransactionService>();
builder.Services.AddScoped<ILicenseRemarksService, LicenseRemarksService>();
builder.Services.AddScoped<IAssLicenseService, AssLicenseService>();
