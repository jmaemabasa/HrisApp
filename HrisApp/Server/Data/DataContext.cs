    ...
    public class DataContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PositionT>().HasData(
                new PositionT { Id = 1, PosCode = "S101", Name = "FSS", DivisionId = 1, DepartmentId = 1, AreaId = 1, Plantilla = 1 /*, SectionId = 1 */}, //No Section Sonic 1
                new PositionT { Id = 2, PosCode = "S102", Name = "Feeder", DivisionId = 1, DepartmentId = 1, AreaId = 1, Plantilla = 9 /*, SectionId = 1*/ },
                new PositionT { Id = 3, PosCode = "S103", Name = "FCCR", DivisionId = 1, DepartmentId = 1, AreaId = 1, Plantilla = 2 /*, SectionId = 1*/ },

                new PositionT { Id = 4, PosCode = "S3K01", Name = "FSS", DivisionId = 1, DepartmentId = 4, AreaId = 1, Plantilla = 1 /*, SectionId = 1*/ }, //No Section Sonic 3 Kidapawan
                new PositionT { Id = 5, PosCode = "S3K02", Name = "DT Booking/ GT Booking", DivisionId = 1, AreaId= 1, DepartmentId = 4, Plantilla = 1 },
                new PositionT { Id = 6, PosCode = "S3K03", Name = "DSS", DivisionId = 1, DepartmentId = 4, AreaId= 1, Plantilla = 1 },
                new PositionT { Id = 7, PosCode = "S3K04", Name = "PM Salesman", DivisionId = 1, DepartmentId = 4, AreaId= 1, Plantilla = 1 },
                new PositionT { Id = 8, PosCode = "S3K05", Name = "OMNI Feeder", DivisionId = 1, DepartmentId = 4, AreaId= 1, Plantilla = 3 },
                new PositionT { Id = 9, PosCode = "S3K06", Name = "FCCR", DivisionId = 1, DepartmentId = 4, AreaId= 1, Plantilla = 1 },

                new PositionT { Id = 10, PosCode = "S3C01", Name = "FSS", DivisionId = 1, DepartmentId = 5, AreaId = 1, Plantilla = 1  /*, SectionId = 1*/ }, //No Section Sonic 3 Cotabato
                new PositionT { Id = 11, PosCode = "S3C02", Name = "DT Booking/ GT Booking", DivisionId = 1, AreaId= 1, DepartmentId = 5, Plantilla = 2 },
                new PositionT { Id = 12, PosCode = "S3C03", Name = "DSS", DivisionId = 1, DepartmentId = 5, AreaId= 1 , Plantilla = 1 },
                new PositionT { Id = 13, PosCode = "S3C04", Name = "OMNI Feeder", DivisionId = 1, DepartmentId = 5 , AreaId= 1, Plantilla = 3 },
                new PositionT { Id = 14, PosCode = "S3C05", Name = "FCCR", DivisionId = 1, DepartmentId = 5 , AreaId= 1, Plantilla = 1 },

                new PositionT { Id = 15, PosCode = "URIC01", Name = "Operations Manager", DivisionId = 1, DepartmentId = 6, AreaId = 1, Plantilla = 1 }, //URIC
                new PositionT { Id = 16, PosCode = "URICHAP01", Name = "HAPI Supervisor", DivisionId = 1, DepartmentId = 6, SectionId = 4, AreaId = 1, Plantilla = 1 }, //URIC HAPI DEALER
                new PositionT { Id = 17, PosCode = "URICHAP02", Name = "HAPI Dealer Coor", DivisionId = 1, DepartmentId = 6, SectionId = 4, AreaId = 1, Plantilla = 4 },
                new PositionT { Id = 18, PosCode = "URICSER01", Name = "Field Sales Supervisor", DivisionId = 1, DepartmentId = 6, SectionId = 5, AreaId = 1, Plantilla = 1 }, //URIC SERVICING
                new PositionT { Id = 19, PosCode = "URICSER02", Name = "MAG Supervisor", DivisionId = 1, DepartmentId = 6, SectionId = 5, AreaId = 1, Plantilla = 1 },
                new PositionT { Id = 20, PosCode = "URICSER03", Name = "GTAS", DivisionId = 1, DepartmentId = 6, SectionId = 5, AreaId= 1, Plantilla = 5 },
                new PositionT { Id = 21, PosCode = "URICSER04", Name = "SMS", DivisionId = 1, DepartmentId = 6, SectionId = 5, AreaId= 1, Plantilla = 11 },
                new PositionT { Id = 22, PosCode = "URICEXP01", Name = "NAO Supervisor", DivisionId = 1, DepartmentId = 6, SectionId = 6, AreaId= 1, Plantilla = 1 }, //URIC EXPANSION
                new PositionT { Id = 23, PosCode = "URICEXP02", Name = "NAO", DivisionId = 1, DepartmentId = 6, SectionId = 6, AreaId= 1, Plantilla = 2 },
                new PositionT { Id = 24, PosCode = "URICEXP02", Name = "HAPI NAO", DivisionId = 1, DepartmentId = 6, SectionId = 6, AreaId= 1, Plantilla = 4 },
                new PositionT { Id = 25, PosCode = "URICDTE01", Name = "IT & Support Services Staff", DivisionId = 1, DepartmentId = 6, SectionId = 7, AreaId= 1, Plantilla = 1 },  //URIC DTEX
                new PositionT { Id = 26, PosCode = "URICDTE02", Name = "Teleservices Support Staff / Online Coor", DivisionId = 1, DepartmentId = 6, SectionId = 7, AreaId = 1, Plantilla = 1 },

                new PositionT { Id = 27, PosCode = "GCASH01", Name = "Field Sales Manager", DivisionId = 1, DepartmentId = 8, AreaId = 1, Plantilla = 1 },  //GCASH
                new PositionT { Id = 28, PosCode = "GCASH02", Name = "Field Sales Supervisor", DivisionId = 1, DepartmentId = 8, AreaId= 1, Plantilla = 1 },  //GCASH
                new PositionT { Id = 29, PosCode = "GCASHSER01", Name = "Field Sales Supervisor", DivisionId = 1, DepartmentId = 8, AreaId= 1, SectionId = 8, Plantilla = 1 },  //GCASH SERVICING
                new PositionT { Id = 30, PosCode = "GCASHSER02", Name = "Sonic DSP", DivisionId = 1, DepartmentId = 8, SectionId = 8, AreaId= 1, Plantilla = 4 },  
                new PositionT { Id = 31, PosCode = "GCASHSER03", Name = "DSP (Commando/Incubator)", DivisionId = 1, DepartmentId = 8, SectionId = 8, AreaId= 1, Plantilla = 6 },
                new PositionT { Id = 32, PosCode = "GCASHEXP01", Name = "Ambassador", DivisionId = 1, DepartmentId = 8, SectionId = 9, AreaId= 1, Plantilla = 2 },  //GCASH EXPANSION
                new PositionT { Id = 33, PosCode = "GCASHMER01", Name = "Merchandiser", DivisionId = 1, DepartmentId = 8, SectionId = 10, AreaId= 1, Plantilla = 3 }, //GCASH MERCHANDISING
                new PositionT { Id = 34, PosCode = "GCASHSCA01", Name = "Scan to Pay", DivisionId = 1, DepartmentId = 8, SectionId = 11, AreaId= 1, Plantilla = 3 }, //GCASH SCAN TO PAY

                new PositionT { Id = 35, PosCode = "GAINV01", Name = "Team Leader/Supervisor", DivisionId = 2, DepartmentId = 9, SectionId = 12, AreaId = 1, Plantilla = 1 }, //FAMS GA - IAP
                new PositionT { Id = 36, PosCode = "GAINV02", Name = "Trade Payable Staff", DivisionId = 2, DepartmentId = 9, SectionId = 12, AreaId= 1, Plantilla = 2 },
                new PositionT { Id = 37, PosCode = "GAINV03", Name = "Non Trade Payable Staff", DivisionId = 2, DepartmentId = 9, SectionId = 12, AreaId= 1, Plantilla = 1 },
                new PositionT { Id = 38, PosCode = "GAGEN01", Name = "Team Leader/Supervisor", DivisionId = 2, DepartmentId = 9, SectionId = 13, AreaId= 1, Plantilla = 1 }, //FAMS GA - GA
                new PositionT { Id = 39, PosCode = "GAGEN02", Name = "Gen Accounting Staff", DivisionId = 2, DepartmentId = 9, SectionId = 13, AreaId= 1, Plantilla = 3 },
                new PositionT { Id = 40, PosCode = "GATAX01", Name = "Team Leader/Supervisor", DivisionId = 2, DepartmentId = 9, SectionId = 14, AreaId= 1, Plantilla = 1 }, //FAMS GA - TC
                new PositionT { Id = 41, PosCode = "GATAX02", Name = "Tax and Compliance Staff", DivisionId = 2, DepartmentId = 9, SectionId = 14, AreaId= 1, Plantilla = 3 },
                new PositionT { Id = 42, PosCode = "SAACC01", Name = "Team Leader", DivisionId = 2, DepartmentId = 10, SectionId = 15, AreaId= 1, Plantilla = 1 }, //FAMS SA - AR
                new PositionT { Id = 43, PosCode = "SAACC02", Name = "Accounts Receivable Staff", DivisionId = 2, DepartmentId = 10, SectionId = 15, AreaId= 1, Plantilla = 4 },
                new PositionT { Id = 44, PosCode = "SACRE01", Name = "Credit and Collection Staff", DivisionId = 2, DepartmentId = 10, SectionId = 16, AreaId= 1, Plantilla = 6 }, //FAMS SA - CC
                new PositionT { Id = 45, PosCode = "SACRE02", Name = "C&C - Billings to Customer", DivisionId = 2, DepartmentId = 10, SectionId = 16, AreaId= 1, Plantilla = 1 },
                new PositionT { Id = 46, PosCode = "SABIL01", Name = "Billing to Cash Settlement Staff", DivisionId = 2, DepartmentId = 10, SectionId = 17, AreaId= 1, Plantilla = 1 }, //FAMS SA - BCS
                new PositionT { Id = 47, PosCode = "IT01", Name = "Manager", DivisionId = 2, DepartmentId = 11, AreaId = 1, Plantilla = 1 }, //FAMS IT
                new PositionT { Id = 48, PosCode = "IT02", Name = "IT Associate", DivisionId = 2, DepartmentId = 11, AreaId= 1, Plantilla = 2 },
                new PositionT { Id = 49, PosCode = "IT03", Name = "IT Staff", DivisionId = 2, DepartmentId = 11, AreaId= 1, Plantilla = 3 },
                new PositionT { Id = 50, PosCode = "TREASURYCAS01", Name = "Cash Operations Head", DivisionId = 2, DepartmentId = 12, SectionId = 18, AreaId = 1, Plantilla = 1 }, //FAMS T -CO
                new PositionT { Id = 51, PosCode = "TREASURYCAS02", Name = "Davao Cashier", DivisionId = 2, DepartmentId = 12, SectionId = 18, AreaId= 1, Plantilla = 3 },
                new PositionT { Id = 52, PosCode = "TREASURYCAS03", Name = "Cotabato Cashier", DivisionId = 2, DepartmentId = 12, SectionId = 18, AreaId= 1, Plantilla = 1 },
                new PositionT { Id = 53, PosCode = "TREASURYCAS04", Name = "Kidapawan Cashier", DivisionId = 2, DepartmentId = 12, SectionId = 18, AreaId= 1, Plantilla = 1 },
                new PositionT { Id = 54, PosCode = "TREASURYCAS05", Name = "Digos Cashier", DivisionId = 2, DepartmentId = 12, SectionId = 18, AreaId= 1, Plantilla = 1 }
                );
