        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 16, 6, 1, "HAPI Supervisor", 1, "URIC02", 4 },
                    { 17, 6, 1, "HAPI Dealer Coor", 4, "URIC03", 4 },
                    { 18, 6, 1, "FIELD SALES Supervisor", 1, "URIC04", 5 },
                    { 19, 6, 1, "MAG Supervisor", 1, "URIC05", 5 },
                    { 20, 6, 1, "GTAS", 5, "URIC06", 5 },
                    { 21, 6, 1, "SMS", 11, "URIC07", 5 },
                    { 22, 6, 1, "NAO Supervisor", 1, "URIC08", 6 },
                    { 23, 6, 1, "NAO", 2, "URIC09", 6 },
                    { 24, 6, 1, "HAPI NAO", 4, "URIC10", 6 },
                    { 25, 6, 1, "IT & Support Services Staff", 1, "URIC11", 7 },
                    { 26, 6, 1, "Teleservices Support Staff / Online Coor", 1, "URIC12", 7 },
                    { 27, 8, 1, "Field Sales Manager", 1, "GCASH01", 0 },
                    { 28, 8, 1, "Field Sales Supervisor", 1, "GCASH02", 0 },
                    { 29, 8, 1, "Field Sales Supervisor", 1, "GCASH03", 8 },
                    { 30, 8, 1, "Sonic DSP", 4, "GCASH04", 8 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 31, 8, 1, "DSP (Commando/Incubator)", 6, "GCASH05", 8 },
                    { 32, 8, 1, "Ambassador", 2, "GCASH06", 9 },
                    { 33, 8, 1, "Merchandiser", 3, "GCASH07", 10 },
                    { 34, 8, 1, "Scan to Pay", 3, "GCASH08", 11 },
                    { 35, 9, 2, "Team Leader/Supervisor", 1, "GAIAP01", 12 },
                    { 36, 9, 2, "Trade Payable Staff", 2, "GAIAP02", 12 },
                    { 37, 9, 2, "Non Trade Payable Staff", 1, "GAIAP03", 12 },
                    { 38, 9, 2, "Team Leader/Supervisor", 1, "GAGA04", 13 },
                    { 39, 9, 2, "Gen Accounting Staff", 3, "GAGA05", 13 },
                    { 40, 9, 2, "Team Leader/Supervisor", 1, "GATC06", 14 },
                    { 41, 9, 2, "Tax and Compliance Staff", 3, "GATC07", 14 },
                    { 42, 10, 2, "Team Leader", 1, "SAAR08", 15 },
                    { 43, 10, 2, "Accounts Receivable Staff", 4, "SAAR09", 15 },
                    { 44, 10, 2, "Credit and Collection Staff", 6, "SACC10", 16 },
                    { 45, 10, 2, "C&C - Billings to Customer", 1, "SACC11", 16 },
                    { 46, 10, 2, "Billing to Cash Settlement Staff", 1, "SABCS012", 16 },
                    { 47, 11, 2, "Manager", 1, "IT01", 0 },
                    { 48, 11, 2, "IT Associate", 2, "IT02", 0 },
                    { 49, 11, 2, "IT Staff", 3, "IT03", 0 },
                    { 50, 12, 2, "Cash Operations Head", 1, "TCO01", 18 },
                    { 51, 12, 2, "Davao Cashier", 3, "TCO02", 18 },
                    { 52, 12, 2, "Cotabato Cashier", 1, "TCO03", 18 },
                    { 53, 12, 2, "Kidapawan Cashier", 1, "TCO04", 18 },
                    { 54, 12, 2, "Digos Cashier", 1, "TCO05", 18 }
                });
