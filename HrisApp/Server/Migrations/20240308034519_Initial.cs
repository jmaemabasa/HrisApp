    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AssetAccessImageT", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AssetAccessImageT_AssetCategoryT_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "AssetCategoryT",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AssetAccessImageT_AssetSubCategoryT_SubCategoryId",
            ...
            migrationBuilder.InsertData(
                table: "AssetTypesT",
                columns: new[] { "Id", "AType_Code", "AType_Name" },
                values: new object[,]
                {
                    { 1, "001", "Main" },
                    { 2, "002", "Accessory" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AssetAccessImageT_CategoryId",
                table: "AssetAccessImageT",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_AssetAccessImageT_SubCategoryId",
                table: "AssetAccessImageT",
