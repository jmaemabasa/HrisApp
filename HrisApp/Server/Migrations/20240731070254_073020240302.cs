...
{
    public partial class _073020240302 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AccessImgLogT", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AccessImgLogT_AssetCategoryT_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "AssetCategoryT",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_AccessImgLogT_AssetSubCategoryT_SubCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccessImgLogT_CategoryId",
                table: "AccessImgLogT",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_AccessImgLogT_SubCategoryId",
                table: "AccessImgLogT",
